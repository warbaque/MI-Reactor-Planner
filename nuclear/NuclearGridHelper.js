            ...
            while (true) {
              ...
              if (component != null) {
                ...
                if (Math.random() < interactionProba) {
                  ...
                  const probaAbsorption = component
                    .getNeutronBehaviour()
                    .interactionRelativeProbability(type, NeutronInteraction.ABSORPTION);
                  ...
                  if (interactionSelector <= probaAbsorption) {
                    ...
                    if (
                      ...
                      Math.random() < component.getNeutronBehaviour().neutronSlowingProbability()
                    ) {
