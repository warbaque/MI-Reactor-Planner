...
class NuclearProductionHistoryComponent extends IntegerHistoryComponent {
  ...
  registerConsumption(type, amount) {
    const historyComponent = (() => {
      switch (type) {
        case Fluids.WATER:
          return NuclearProductionHistoryComponentType.waterConsumption;
        case Fluids.HEAVY_WATER:
          return NuclearProductionHistoryComponentType.heavyWaterConsumption;
        case Fluids.HIGH_PRESSURE_WATER:
          return NuclearProductionHistoryComponentType.highPressureWaterConsumption;
        case Fluids.HIGH_PRESSURE_HEAVY_WATER:
          return NuclearProductionHistoryComponentType.highPressureHeavyWaterConsumption;
        case Fuels.URANIUM_1:
        case Fuels.URANIUM_2:
        case Fuels.URANIUM_4:
          return NuclearProductionHistoryComponentType.uraniumRodConsumption;
        case Fuels.LE_MOX_1:
        case Fuels.LE_MOX_2:
        case Fuels.LE_MOX_4:
          return NuclearProductionHistoryComponentType.leMoxRodConsumption;
        case Fuels.LE_URANIUM_1:
        case Fuels.LE_URANIUM_2:
        case Fuels.LE_URANIUM_4:
          return NuclearProductionHistoryComponentType.leUraniumRodConsumption;
        case Fuels.HE_MOX_1:
        case Fuels.HE_MOX_2:
        case Fuels.HE_MOX_4:
          return NuclearProductionHistoryComponentType.heMoxRodConsumption;
        case Fuels.HE_URANIUM_1:
        case Fuels.HE_URANIUM_2:
        case Fuels.HE_URANIUM_4:
          return NuclearProductionHistoryComponentType.heUraniumRodConsumption;
        case Items.INVAR_PLATE:
          return NuclearProductionHistoryComponentType.invarPlateConsumption;
        case Items.CARBON_PLATE:
          return NuclearProductionHistoryComponentType.carbonPlateConsumption;
        case Items.CONTROL_ROD:
          return NuclearProductionHistoryComponentType.controlRodConsumption;
      }
    })();
  ...
  registerProduction(type, amount) {
    const historyComponent = (() => {
      switch (type) {
        case Fluids.STEAM:
          return NuclearProductionHistoryComponentType.steamProduction;
        case Fluids.HEAVY_WATER_STEAM:
          return NuclearProductionHistoryComponentType.heavyWaterSteamProduction;
        case Fluids.HIGH_PRESSURE_STEAM:
          return NuclearProductionHistoryComponentType.highPressureSteamProduction;
        case Fluids.HIGH_PRESSURE_HEAVY_WATER_STEAM:
          return NuclearProductionHistoryComponentType.highPressureHeavyWaterSteamProduction;
        case Fluids.DEUTERIUM:
          return NuclearProductionHistoryComponentType.deuteriumProduction;
        case Fluids.TRITIUM:
          return NuclearProductionHistoryComponentType.tritiumProduction;
      }
    })();
